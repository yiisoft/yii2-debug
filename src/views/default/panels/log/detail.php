...
echo GridView::widget([
    ...
    'rowOptions' => function ($model) {
        switch ($model['level']) {
            case Logger::LEVEL_ERROR : return ['class' => 'table-danger'];
            case Logger::LEVEL_WARNING : return ['class' => 'table-warning'];
            case Logger::LEVEL_INFO : return ['class' => 'table-success'];
            default: return [];
        }
    },
    'columns' => [
