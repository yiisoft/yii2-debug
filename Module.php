...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    /**
     * @var string if set, replaces the base path on the value of the {file} placeholder with this value.
     * This is especially useful if the development environment exists on a different filesystem than the executed code,
